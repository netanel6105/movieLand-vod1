          ...
          <form onSubmit={handleSubmit(onSub)} className="mt-8 space-y-6" >
            ...
            <div className="-space-y-px rounded-md shadow-sm">
              <div >
                ...
                <input
                  {...register('fullName', { required: {value:true,message:'name is required'}, minLength: {value:2,message:'At least 2 characters'}, maxLength: {value:20,message:'Maximum 20 characters'} })}
                  type="text"
              ...
              <div >
                ...
                <textarea
                  rows={3}
                  {...register('profileImg', { maxLength: {value:9999,message:'Maximum characters'} })}
                  type="text"
